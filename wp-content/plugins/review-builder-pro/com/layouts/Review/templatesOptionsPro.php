<div class="sgrb-template-options">
	<div class="sg-row">
		...
		<div class="sg-col-4">
			<div class="sgrb-total-options-rows-rate-type">
				<p><label for="sgrb-template-shadow-on"><input id="sgrb-template-shadow-on" name="template-field-shadow-on" value="true" type="checkbox"<?php echo (@$sgrbDataArray['template-field-shadow-on']) ? ' checked' : '' ?>> <?php echo _e('Text boxes shadow effect', 'sgrb');?> </label></p>
			</div>
